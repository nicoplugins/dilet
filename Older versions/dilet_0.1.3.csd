...
rslider bounds(535, 195, 90, 90), channel("analogKnob"), range(0, 1, 0, 1, 0.01), text("Analog"), trackercolour(204, 255, 0, 255), outlinecolour(0, 0, 0, 0), textcolour(255, 255, 255, 255), valuetextbox(1)

;Controles para el filtro:
rslider bounds(342, 188, 100, 100), channel("HPF"), identchannel("HPFident"), text("HPF"), range(20, 20000, 20, 0.375, 1), trackercolour(204, 255, 0, 255), outlinecolour(0, 0, 0, 0), textcolour(255, 255, 255, 255), valuetextbox(1)
rslider bounds(450, 188, 100, 100), channel("LPF"), identchannel("LPFident"), text("LPF"), range(20, 20000, 20000, 0.375, 1), trackercolour(204, 255, 0, 255), outlinecolour(0, 0, 0, 0), textcolour(255, 255, 255, 255), valuetextbox(1)
encoder bounds(415, 210, 60, 60), channel("filterLink"), text("link"), increment(1)
...
rslider bounds(535, 10, 90, 90), channel("dryWet"), range(0, 1, 0.5, 1, 0.01), text("Dry/Wet"), trackercolour(204, 255, 0, 255), outlinecolour(0, 0, 0, 0), textcolour(255, 255, 255, 255), valuetextbox(1)
rslider bounds(535, 95, 90, 90), channel("output"), range(0, 1, 1, 1, 0.01), text("Output"), trackercolour(204, 255, 0, 255), outlinecolour(0, 0, 0, 0), textcolour(255, 255, 255, 255), valuetextbox(1)
...
instr		ModDelay
	...
	*/
	...
	outs	aMixL*kOutput, aMixR*kOutput 	;Salidas del plugin.
