...
form    caption("Mod Delay") size(450,450), colour(28,69,135), pluginid("BPMCalc")
...
rslider bounds(10, 210, 100, 100), channel("feedback"), range(0, 1, 0, 1, 0.01), text("Feedback"), trackercolour(204,255,0), outlinecolour(0,0,0,0), textcolour("white")
...
button bounds(120, 60, 40, 40), channel("whole"), text("W"), colour:0("black"), colour:1("blue"), outlinecolour(0,0,0,0), fontcolour:0("white"), radiogroup(1)
button bounds(160, 60, 40, 40), channel("half"), text("H"), colour:0("black"), colour:1("blue"), outlinecolour(0,0,0,0), fontcolour:0("white"), radiogroup(1)
button bounds(200, 60, 40, 40), channel("quarter"), text("Q"), colour:0("black"), colour:1("blue"), outlinecolour(0,0,0,0), fontcolour:0("white"), radiogroup(1)
button bounds(240, 60, 40, 40), channel("eighth"), text("E"), colour:0("black"), colour:1("blue"), outlinecolour(0,0,0,0), fontcolour:0("white"), radiogroup(1)
button bounds(280, 60, 40, 40), channel("sixteenth"), text("S"), colour:0("black"), colour:1("blue"), outlinecolour(0,0,0,0), fontcolour:0("white"), radiogroup(1)
...
button bounds(220, 330, 40, 40), channel("sine"), value(1), text("Sine"), colour:O("black"), colour:1("blue"), outlinecolour(0,0,0,0), radiogroup(2)
button bounds(260, 330, 40, 40), channel("triangle"), text("Tri"), colour:O("black"), colour:1("blue"), outlinecolour(0,0,0,0), radiogroup(2)
button bounds(220, 370, 40, 40), channel("sawUp"), text("Up"), colour:O("black"), colour:1("blue"), outlinecolour(0,0,0,0), radiogroup(2)
button bounds(260, 370, 40, 40), channel("sawDown"), text("D"), colour:O("black"), colour:1("blue"), outlinecolour(0,0,0,0), radiogroup(2)
...
button bounds(240, 10, 80, 40), channel("pingPong"), text("Ping-Pong"), colour:0("black"), colour:1("orange"), outlinecolour(0,0,0,0), textcolour("white")

;Perilla de relación entre efecto y señal original:
rslider bounds(340, 10, 100, 100), channel("dryWet"), range(0, 1, 0, 1, 0.01), text("Dry/Wet"), trackercolour(204,255,0), outlinecolour(0,0,0,0), textcolour("white")
...
opcode  saturator, a, a
	...
	aHPF    atone       aComp*kMakeUp, kHPCf
	aLPF    tone        aHPF, kLPCf
     		xout 	    aLPF
...
opcode  pingPong, aa, akaii
    ...
    aDelL 	vdelayxw	aIn + aDelR*kFdbk, aVar, iMax, iWindow
	aDelR 	vdelayxw	aDelL*kFdbk, aVar, iMax, iWindow
