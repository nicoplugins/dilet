...
form    caption("Mod Delay") size(725,300), colour(28,69,135), pluginid("modDelay")
...
button bounds(280, 250, 20, 20), channel("sawDown"), text("d", "d"), , colour:1(0, 0, 255, 255), outlinecolour(0, 0, 0, 0), radiogroup("3")
...
rslider bounds(635, 95, 90, 90), channel("output"), range(0, 1, 1, 1, 0.01), text("Output"), trackercolour(204, 255, 0, 255), outlinecolour(0, 0, 0, 0), textcolour(255, 255, 255, 255), valuetextbox(1), markercolour(0, 0, 0, 0)
...
instr		ModDelay
    ...
    elseif  kTapMsButton==1 then
            ...
            elseif  kTaps[1]=0  then
                kTapMs   =   kTaps[0]
            elseif  kTaps[2]=0  then
                kTapMs   =   (kTaps[0]+kTaps[1])/2
            elseif  kTaps[3]=0  then
                kTapMs   =   (kTaps[0]+kTaps[1]+kTaps[2])/3
            elseif  kTaps[4]=0  then
                kTapMs   =   (kTaps[0]+kTaps[1]+kTaps[2]+kTaps[3])/4
            elseif  kTaps[5]=0  then
                kTapMs   =   (kTaps[0]+kTaps[1]+kTaps[2]+kTaps[3]+kTaps[4])/5
            elseif  kTaps[6]=0  then
                kTapMs   =   (kTaps[0]+kTaps[1]+kTaps[2]+kTaps[3]+kTaps[4] \
                                +kTaps[5])/6
            elseif  kTaps[7]=0  then
                kTapMs   =   (kTaps[0]+kTaps[1]+kTaps[2]+kTaps[3]+kTaps[4] \
                                +kTaps[5]+kTaps[6])/7
            elseif  kTaps[7]!=0     then
                kTapMs   =   (kTaps[7]+kTaps[6]+kTaps[5]+kTaps[4]+kTaps[3] \
                                +kTaps[2]+kTaps[1]+kTaps[0])/8
            endif
