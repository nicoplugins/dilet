...
form    caption("dilet") size(725,300), colour(50, 0, 50), pluginid("dilt"), guirefresh(10), bundle("./Assets", "./Opcodes", "dilet.snaps"), titlebarcolour(50, 0, 50)
...
label bounds(25, 205, 65, 15), text("Alfa 1.0.0")
...
combobox    bounds(195, 165, 70, 20), populate("*.snaps")
;combobox    bounds(120, 165, 70, 20), populate("*.snaps")
;image bounds(132, 165, 60, 20), file("Assets/presets.png")
filebutton  bounds(120, 165, 70, 20), channel("filebutton"), text("Save preset"), mode("file"), svgfile("Off", "savePresetOff.svg"), svgfile("On", "savePresetOn.svg")
...
rslider bounds(110, 10, 165, 165), channel("outline"), identchannel("outlineIdent"), range(0.001, 4, 0.001, 0.5, 0.001), trackercolour(0, 204, 255, 255), outlinecolour(0, 0, 0, 0), trackeroutsideradius(1), markercolour(0,0,0,0), colour(50, 0, 50, 0)
...
;button bounds(280, 250, 20, 20), channel("random"), text(""), imgfile("Off", "Assets/randomOff.png"), imgfile("On", "Assets/randomOn.png"), radiogroup("3")
;button bounds(302, 250, 20, 20), channel("showDual"), text(""), imgfile("Off", "Assets/dualOff.png"), imgfile("On", "Assets/dualOn.png")
